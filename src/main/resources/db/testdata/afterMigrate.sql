...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp, true, true, 1);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id) values (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, utc_timestamp, true, true, 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id) values (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp, true, true, 2);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id) values (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp, true, true, 3);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp, true, true, 3);
...
(1, 'João da Silva', 'joao.ger@algafood.com.br', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com.br', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com.br', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com.br', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(6, 'Débora Mendonça', 'email.teste.aw+debora@gmail.com', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp),
(7, 'Carlos Lima', 'email.teste.aw+carlos@gmail.com', '$2a$12$0lxMINuSWf0d7nltRCnsg.F9DtsQp8O9w9od6xxdq6lQVH40uKsji', utc_timestamp);

insert into usuario_grupo (usuario_id, grupo_id) values (1, 1), (1, 2), (2, 2), (3, 3), (4, 4);

insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) VALUES (1, 1), (2, 2), (3, 3), (4,1), (1, 5), (3, 5);
